          ...
          var b,
            ...
            f = {
              ...
              setColumns: function() {
                0 !== a.items.length &&
                  void 0 === c &&
                  (c = void 0 === a.searchColumns ? f.toArray(a.items[0].values()) : a.searchColumns);
              },
            ...
            g = {
              ...
              values: function(c, e) {
                return !!(
                  c.hasOwnProperty(e) && ((b = a.utils.toString(c[e]).toLowerCase()), '' !== d && b.search(d) > -1)
                );
              },
              reset: function() {
      ...
      function(a, b, c) {
        b.exports = function(a) {
          a.sortFunction =
            ...
            function(b, c, d) {
              return (
                (d.desc = 'desc' == d.order), a.utils.naturalSort(b.values()[d.valueName], c.values()[d.valueName], d)
              );
            };
          var b = {
              els: void 0,
      ...
      function(a, b, c) {
        ...
        (b.exports = function(a) {
          ...
          (d.prototype.toggle = function(a, b) {
            return this.list
              ? ('undefined' != typeof b ? b !== this.list.toggle(a, b) && this.list.toggle(a) : this.list.toggle(a),
                this)
              : ('undefined' != typeof b
                  ? b
                    ? this.add(a)
