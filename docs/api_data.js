  ...
  api: [
    {
          ...
          'Success 200': [
            {
              ...
              optional: false,
              field: '_id',
              description: '<p>Id of the Button.</p>',
            },
          ],
        },
        examples: [
      ...
      version: '0.0.0',
      filename: 'server/api/endpoints/button/routes.js',
      groupTitle: 'Button',
    },
    {
      type: 'get',
      url: '/user',
      title: 'Get Buttons information',
      name: 'GetButtons',
      group: 'Button',
      permission: [
        {
          ...
          'Error 4xx': [
            {
              ...
              optional: false,
              field: '404',
              description: '<p>The id of the Button was not found.</p>',
            },
          ],
        },
        examples: [
    ...
    },
    {
      ...
      version: '0.0.0',
      filename: 'server/api/endpoints/mu/routes.js',
      groupTitle: 'Mu',
    },
    {
      type: 'get',
      url: '/user',
      title: 'Get Mus information',
      name: 'GetMus',
      group: 'Mu',
      permission: [
        {
        ...
        fields: {
          Parameter: [
            ...
            },
            {
              ...
              optional: false,
              field: 'description',
              description: '<p>Description of the .</p>',
            },
          ],
        },
      },
          ...
          'Error 4xx': [
            {
              ...
              optional: false,
              field: '404',
              description: '<p>The id of the Mu was not found.</p>',
            },
          ],
        },
        examples: [
